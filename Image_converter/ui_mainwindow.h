...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(160, 70, 201, 171));
        label->setPixmap(QPixmap(QString::fromUtf8(":/new/logo/logo3.png")));
        label->setScaledContents(true);
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(60, 10, 411, 61));
        QFont font;
        font.setFamily(QStringLiteral("Vani"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QApplication::translate("MainWindow", "Image Converter", Q_NULLPTR));
        pushButton->setText(QApplication::translate("MainWindow", "Brows", Q_NULLPTR));
        comboBox->clear();
